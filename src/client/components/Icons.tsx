...
export function JiraIcon({ size = 14, className }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 16 16" fill="currentColor">
      <path d="M15.04 7.3L8.7.96 8 .26 2.67 5.6.96 7.3a.33.33 0 000 .47l4.57 4.57L8 14.8l5.33-5.33.24-.24 1.47-1.47a.33.33 0 000-.47zM8 10.27L5.73 8 8 5.73 10.27 8 8 10.27z"/>
    </svg>
  );
}
